    ...
    >
      ...
      <div className="container-custom relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          >
            <div className="relative w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 rounded-full p-2 bg-gradient-to-tr from-indigo-500 via-purple-500 to-pink-500">
              ...
              {/* Glow behind */}
              <div className="absolute inset-0 rounded-full bg-gradient-to-tr from-indigo-500 via-purple-500 to-pink-500 blur-3xl opacity-30 -z-10" />
            </div>
          </motion.div>

          {/* Right Column: Content */}
          <motion.div
            className="lg:col-span-7 text-center lg:text-left order-2"
        ...
        {/* Stats with animated counters and icons - Full Width Bottom */}
        <motion.div
          variants={itemVariants}
          initial="hidden"
          whileInView="visible"
